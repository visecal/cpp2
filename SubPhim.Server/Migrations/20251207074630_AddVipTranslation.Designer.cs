...
namespace SubPhim.Server.Migrations
{
    ...
    [Migration("20251207074630_AddVipTranslation")]
    partial class AddVipTranslation
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SubPhim.Server.Data.LocalApiSetting", b =>
                {
                    ...
                    b.Property<int>("GlobalMaxRequests")
                        .HasColumnType("INTEGER");

                    b.Property<int>("GlobalWindowMinutes")
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("SubPhim.Server.Data.TierDefaultSetting", b =>
                {
                    ...
                    b.Property<int>("DailyVipTranslationLimit")
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("SubPhim.Server.Data.User", b =>
                {
                    ...
                    b.Property<int>("DailyVipTranslationLimitOverride")
                        .HasColumnType("INTEGER");
                    ...
                    b.Property<DateTime>("LastVipTranslationResetUtc")
                        .HasColumnType("TEXT");
                    ...
                    b.Property<int>("VipTranslationLinesUsedToday")
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("SubPhim.Server.Data.VipOriginalSrtLine", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
                    ...
                    b.ToTable("VipOriginalSrtLines");
                });

            modelBuilder.Entity("SubPhim.Server.Data.VipTranslatedSrtLine", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
                    ...
                    b.ToTable("VipTranslatedSrtLines");
                });

            modelBuilder.Entity("SubPhim.Server.Data.VipTranslationJob", b =>
                {
                    b.Property<string>("SessionId")
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("SubPhim.Server.Data.VipOriginalSrtLine", b =>
                {
                    b.HasOne("SubPhim.Server.Data.VipTranslationJob", "Job")
                        .WithMany("OriginalLines")
                        .HasForeignKey("SessionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
