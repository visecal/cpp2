    ...
    public class GlobalRequestRateLimiterService
    {
        ...
        public async Task RefreshSettingsAsync(bool forceRefresh = false)
        {
            ...
            try
            {
                ...
                // GlobalMaxRequests và GlobalWindowMinutes đã bị xoá khỏi database
                // Sử dụng giá trị mặc định cố định
                int newMaxRequests = 20;
                int newWindowMinutes = 2;
                
                // Không cần kiểm tra settings nữa vì không có trường nào để đọc
